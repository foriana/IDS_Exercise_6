...
```{r, fig.height = 10, fig.width = 10, fig.alt="Below shows three different graphs about the Olympic gold medals awarded to different participating countries."}
...
```{r, fig.alt= "Graph of", fig.height= 4}
course_df %>% 
