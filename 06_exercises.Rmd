...
```{r, fig.alt="This shows a table of the cumulative gold medals different countries have won during Olympic competitions. The United States of America leads in gold medals earned with 2,638 medals as of 2016, which is more than 1,000 more gold medals than the next country, Russia."}
...
```{r, fig.alt = "This is a table of Lisa Lendway's harvested beans, carrots, tomatoes. It shows the summed weight of each variety and each different vegetable has its varieties displayed in descending order of weight."}
soup_ingredients %>% 
  gt() %>% 
  data_color(
    columns = vars(weight),
...
```{r, fig.height = 13, fig.width = 15, fig.alt="Below shows three different graphs about the Olympic gold medals awarded to different participating countries. The bar chart on the left shows the amount of gold medals in figure skating earned by each country. The top right map shows the gold medal earnings around the world. The bottom right line graph shows the top five countries that win figure skating gold medals and their cumulative wins over time."}
...
```{r, fig.alt= "Graph of Macalester College's Fall 2017 Course Offerings and the number of courses offered by each department. Hispanic Studies offers the most courses.", fig.height= 4}
course_df %>% 
